        ...
        <h:form action="/reg" method="post">
            <table class="tab1" align="center" width="500" > 
                ...
                <tr>
                    ...
                    <td width="250"><h:text property="lname" /><span class="qmail">@qmail.com</span></td>
                </tr>
                <tr>
                    <td width="170">UserName</td>
                    <td width="250"><h:text property="ruser" /></td>
                </tr>
                <tr>
